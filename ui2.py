...
class Recommendation:
    ...
    def generate(self):
        ...
        # If your generator returns JSON, uncomment: recommendations = recommendations.json()['output']
        if recommendations:
...
class Display:
    ...
    def display_recommendation(self, recommendations):
        ...
        if recommendations:
            ...
            rows_needed = (num_recipes + cols - 1) // cols  # Ceiling division for even distribution
    ...
    def display_overview(self, recommendations):
        if recommendations:
            ...
            selected_recipe = next((recipe for recipe in recommendations if recipe['Name'] == selected_recipe_name), None)
            if selected_recipe:
                options = {
